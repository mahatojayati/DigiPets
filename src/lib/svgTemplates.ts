/**
 * Procedural SVG Pet Generator for Client-Side Fallback & Instant Generation
 */
...
const EYE_TYPES = ["sparkle", "happy", "wink", "cool"];
const EAR_TYPES = ["cat", "bear", "bunny", "fox"];

export function generatePetSvg(prompt: string): { svg: string; width: number; height: number; dataUrl: string } {
  ...
  const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 320" width="100%" height="100%">
      ...
      <g filter="url(#soft-shadow)">
        ${earsSvg}
        <path d="M 60,180 C 60,110, 260,110, 260,180 C 260,250, 240,265, 160,265 C 80,265, 60,250, 60,180 Z" fill="${baseColor}" stroke="#2D3436" stroke-width="8" stroke-linejoin="round" />
        <path d="M 60,180 C 60,110, 260,110, 260,180 C 260,250, 240,265, 160,265 C 80,265, 60,250, 60,180 Z" fill="url(#body-grad)" style="mix-blend-mode: overlay;" />
  ...
  return { svg, width: 320, height: 320, dataUrl };
}
